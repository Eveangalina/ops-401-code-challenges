...
# Script Name:                  Network Availability Email Notification Tool
# Author Name:                  Eveangalina Campos
# Date of latest revision:      01/21/2024
# Purpose:                      This script monitors a specified IP address for network availability and sends email notifications upon status change.
